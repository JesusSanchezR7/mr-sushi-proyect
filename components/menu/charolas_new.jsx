...
export default function Charolas() {
    ...
    const createPreference = async () => {
        ...
        try {
            ...
            const response = await axios.post("https://senorsushi.businesscodecreators.com/create_prefernece", {
                title: "TOTAL:",
                quantity: 1,
                price: totalPrice,
            });
            ...
            */
            ...
            //const result =  await preference.create();s
          //  const results = await preference.create({body: body})
